...
const DeleteConfirmationModal = ({ artist, onConfirm, onClose }) => {
        ...
        >
          ...
          >
            ...
            <p className="text-slate-400">
              Êtes-vous sûr de vouloir supprimer l'artiste <strong className="text-slate-200">{artist?.name}</strong> ?
            </p>
